        ...
        for i in range(1, geo.Nx):
            ...
            for j in range(geo.Ny):
                ...
                if i == 1:
                    ...
                    Tri.RHS_col[k] += (-Faces.a_e_u[i,j]*Fields.u[i+1,j]) + (-Faces.a_w_u[i,j]*var.u_inlet)
        ...
        for j in range(geo.Ny):
            ...
            for i in range(1, geo.Nx):
                ...
                if i == 1:
                    ...
                    Tri.RHS_row[k] += -Faces.a_w_u[i,j]*var.u_inlet
                ...
                if j == 0:
                    ...
                    Tri.RHS_row[k] += -Faces.a_s_u[i,j]*Fields.u[i,j-1] 
